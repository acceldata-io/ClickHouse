    ...
    def validate(cls):
        ...
        for workflow in workflows:
            ...
            if workflow.enable_cidb:
                cls.evaluate_check(Settings.SECRET_CI_DB_URL, "Settings.SECRET_CI_DB_URL must be provided if workflow.enable_cidb=True", workflow)
                cls.evaluate_check(Settings.SECRET_CI_DB_USER, "Settings.SECRET_CI_DB_USER must be provided if workflow.enable_cidb=True", workflow)
                cls.evaluate_check(Settings.SECRET_CI_DB_PASSWORD, "Settings.SECRET_CI_DB_PASSWORD must be provided if workflow.enable_cidb=True", workflow)
                cls.evaluate_check(Settings.CI_DB_DB_NAME, "Settings.CI_DB_DB_NAME must be provided if workflow.enable_cidb=True", workflow)
                cls.evaluate_check(Settings.CI_DB_TABLE_NAME, "Settings.CI_DB_TABLE_NAME must be provided if workflow.enable_cidb=True", workflow)
